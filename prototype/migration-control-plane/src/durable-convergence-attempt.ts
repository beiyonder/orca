...
export async function completeDurableFencedAttempt(
  ...
  await withPostgresTransaction(pool, async (client) =>
    insertPostgresDomainRecords(client, [
      ...
      {
        tenantId: fixture.tenantId,
        recordId: fixture.evaluatorDefinition.id,
        missionId: null,
        schemaName: 'evaluator-definition.v2',
        recordKind: 'evaluator-definition',
        recordState: 'active',
        payload: fixture.evaluatorDefinition,
        createdAt: fixture.evaluatorDefinition.createdAt
      },
      {
        tenantId: fixture.tenantId,
        recordId: fixture.evaluationContract.id,
        missionId: null,
        schemaName: 'evaluation-contract.v2',
        recordKind: 'evaluation-contract',
        recordState: 'active',
        payload: fixture.evaluationContract,
        createdAt: fixture.evaluationContract.createdAt
      },
      {
        tenantId: fixture.tenantId,
        recordId: fixture.evaluationEvidence.id,
        missionId: fixture.missionId,
        schemaName: 'evidence-item.v1',
        recordKind: 'evidence-item',
        recordState: 'current',
        payload: fixture.evaluationEvidence,
        createdAt: fixture.evaluationEvidence.createdAt
      },
      {
        tenantId: fixture.tenantId,
