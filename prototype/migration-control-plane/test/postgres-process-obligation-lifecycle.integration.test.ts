...
import {
  ...
  insertProcessObligationProofRecord as insertProofRecord,
  instantiateProcessObligation as instantiateObligation,
  processObligationSystemActor as systemActor,
  registerProcessObligationTestDefinition as registerDefinition
    ...
    await context.pool.query(
      `UPDATE control_plane.process_obligations
       SET obligation_state = 'pending', proof_record_ids = '[]'::jsonb,
           ...
           monitor_claimed_at = transaction_timestamp() - interval '2 seconds',
