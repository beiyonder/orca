...
1. `P3-KERN-07` through `P3-KERN-10` — prove DAG guards, task/attempt authority, fencing, and explicit effect state.
2. `P3-KERN-11` through `P3-KERN-13` — prove projection replay, restart reconciliation, and durable convergence.
